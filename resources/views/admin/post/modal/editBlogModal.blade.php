            ...
            <form id="editBlogForm">
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <textarea class="form-control" name="description" id="editDescription" placeholder="Blog Description" required></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="editFeatureImages" class="col-sm-4 control-label">Feature Images (Optional)</label>
                        <p></p>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row feature-images-container">
                        <label class="col-sm-4 control-label">Current Feature Images</label>
                        <div class="col-sm-8">
